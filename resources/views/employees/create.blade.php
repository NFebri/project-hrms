...
<x-section-main>
    <x-slot name="section_header_title">
        <h1>{{ __('Employees') }}</h1>
        <x-section-header-breadcrumb :breadcrumb="['Master', 'Employees', 'Create']" />
    </x-slot>
                    ...
                    <form action="{{ route('employees.store') }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                @enderror
                                <small id="passwordHelp" class="form-text text-muted">{{ __('Employee will login using this password.') }}</small>
                            </div>
                        </div>
